...
public class BagTest {
    public static void main(String[] args) {
        //Create an obj of ArrayBag<String>
        ...
        //TODO: Add the above strings into the bag:
    ...
    public static void bagStatusReport(LinkedBag<String> myBag){
        ...
        System.out.println("Bag contains: "+myBag.contains("A"));
        System.out.println("Bag contains: "+myBag.contains("B"));
        System.out.println("Bag contains: "+myBag.contains("C"));
        System.out.println("Bag contains: "+myBag.contains("D"));
